...
plot(tsna::tSnaStats(classroom, snafun = "gden", time.interval = 5, aggregate.dur = 5))
...
### Number of active edges ovr time
...
in subgroups on assignments and all discuss the assigmnent) and times when 
...
```{r, eval = FALSE}
SNA4DS::plot_network_slices(classroom, number = 4, 
                    start = 0, end = 45,
                    digits = 3)
```
...
But if you were to run this from the console, this is the plot you would get.
...
the browser window, next to your animation, and change the duration there.
...
- search with your mouse in the upper right corner of your browser window, until 
you see the shape of the cursor change.
...
Feel free to play around with the settings, adjust the plot further to your 
liking.
