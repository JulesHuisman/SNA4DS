...
igraph::shortest_paths(media_net, "s01", to = V(media_net), mode =  "all", output = "vpath")
...
igraph::edge_density(as.undirected(media_net), loops=TRUE) 
...
# out degree
igraph::degree(media_net, v = V(media_net), mode = "out", loops = TRUE, normalized = FALSE)
# in degree
igraph::degree(media_net, v = V(media_net), mode = "in", loops = TRUE, normalized = FALSE)
# total degree
igraph::degree(media_net, v = V(media_net), mode = "total", loops = TRUE, normalized = FALSE)
...
Umedia_net <- as.undirected(media_net)

igraph::degree(Umedia_net, v = V(Umedia_net), mode = "all", loops = TRUE, normalized = FALSE)
...
# media network
assortativity_degree(media_net)
```
...
assortativity(media_net, V(media_net)$audience.size, directed=T)
