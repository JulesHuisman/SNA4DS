...
data.frame(betweenness = betweenness(friendship), names = network::get.vertex.attribute(friendship, "name"))
```
...
This happens in the next tutorial: `lab01-networkIntro`.
You can start it by running

```{r, eval = FALSE}
learnr::run_tutorial("lab01-networkIntro", package = "SNA4DS")
```
