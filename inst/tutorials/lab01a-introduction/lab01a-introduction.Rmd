...
```{r library1, message = FALSE, warning = FALSE, exercise = TRUE, dependson="data"}
library(sna)
...
```{r library1a, exercise = TRUE, dependson="data"}
...
```{r library_error, exercise = TRUE, dependson="data"}
...(friendship)
```
...
```{r library2a, exercise = TRUE, dependson="data"}
...
```{r library3, exercise = TRUE, dependson="data"}
library(sna)
