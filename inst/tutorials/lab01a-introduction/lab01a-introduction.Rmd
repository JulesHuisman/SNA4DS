...
```{r sna_inladen, message = FALSE, warning = FALSE, echo = FALSE, exercise.setup = "load_data"}
...
```{r library_error, exercise = TRUE, exercise.setup = c("load_data", "influenceR_setup")}
...(friendship)
```
