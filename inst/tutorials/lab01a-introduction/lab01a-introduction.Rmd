...
quiz(
  question("How would you get help for the function that implements the _walktrap_ algorithm?",
...
```{r library1, message = FALSE, warning = FALSE, exercise = TRUE}
library(sna)
...
very different result than wanted (because who says that the `betweenness`
...
```{r nextTutorial, eval = FALSE, exercise = TRUE}
learnr::run_tutorial("lab01b-networksInR", package = "SNA4DS")
```
