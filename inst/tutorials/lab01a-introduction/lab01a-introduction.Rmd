...
```{r library1, message = FALSE, warning = FALSE, exercise = TRUE, exercise.setup = "nw_data-laden"}
library(sna)
betweenness(friendship)
```

```{r sna_inladen, message = FALSE, warning = FALSE, echo = FALSE, exercise.setup = "nw_data-laden"}
...
```{r library1a, exercise = TRUE, exercise.setup = "sna_inladen", message = FALSE, warning = FALSE}
...
```{r influenceR_laden, exercise = TRUE, exercise.setup = "sna_inladen"}
library(influenceR)
```
...
```{r library_error, exercise = TRUE, exercise.setup = c("nw_data-laden", "influenceR_setup")}
...(friendship)
```
...
```{r library3, exercise = TRUE, exercise.setup = "library_error"}
