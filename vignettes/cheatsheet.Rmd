...
```{r table_generate, echo = FALSE, eval = TRUE}
...
and a `print` method (that you use to check model assumptions).
...
See (the data generation table)[table_generate] for these functions.
